...
import { Users, BookOpen, MessageSquare, Shield, LogOut, LayoutDashboard, Columns2, Languages, Globe, FileText, ClipboardList, ClipboardCheck } from "lucide-react";
...
const links = [
  ...
  { to: "/admin/test-attempts", label: "Test Attempts", icon: ClipboardCheck },
  ...
  { to: "/admin/ui-translations", label: "UI Translations", icon: Languages },
  { to: "/admin/content-translations", label: "Content Translations", icon: FileText },
];
