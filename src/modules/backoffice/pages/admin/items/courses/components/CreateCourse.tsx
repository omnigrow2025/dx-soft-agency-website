...
import {
  ...
  type CreateCourseFormModel,
} from "../validations/createCourse.validation";
...
export const CreateCourse = () => {
  ...
  const onSubmit = (data: CreateCourseFormModel) => {
    create(
      {
        ...data,
        img: data.img[0],
      ...
      <div className="p-4 border-b border-gray-200 bg-gray-50">
        <nav className="text-sm breadcrumbs">
          <ul className="flex gap-2 text-gray-600">
            ...
            <li className="text-gray-800 font-semibold">Create Course</li>
          </ul>
        </nav>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 p-4">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Enter course certificate..."
          />
          {errors.certificate && (
